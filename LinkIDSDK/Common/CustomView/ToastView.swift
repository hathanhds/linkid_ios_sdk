...
//        view.image = .iconCheckCircleWhite
...
//    }()
//
//    required init(type: ToastType, message: String?, icon: UIImage?, backgroundColor: UIColor?) {
//        super.init(frame: CGRect(x: 0, y: 0, width: UtilHelper.screenWidth - 40, height: 0))
...
//            messageLabel.trailingAnchor.constraint(greaterThanOrEqualTo: trailingAnchor, constant: -padding),
//            messageLabel.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -padding),
//            ])
//    }
//
//    func show(superView: UIView, duration: TimeInterval? = 5.0) {
//        superView.addSubview(self)
//        UIView.animate(withDuration: duration ?? 5.0, delay: 1.0, options: .allowUserInteraction, animations: {
//            self.alpha = 0.0
...
//        self.addSubviews()
    ...
    func setup() {
        ...
        NSLayoutConstraint.activate([
            ...
            messageLabel.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -padding),
//            topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor, constant: padding),
//            leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor, constant: 20),
//            trailingAnchor.constraint(equalTo: safeAreaLayoutGuide.trailingAnchor, constant: -20),
            ])
    }
