...
class OTPStackView: UIStackView {
    ...
    //Colors
    let warningColor: UIColor = .cF5574E!
    let inactiveFieldBorderColor: UIColor = .cD8D6DD!
    let textBackgroundColor: UIColor = .c242424!
    let activeFieldBorderColor: UIColor = .mainColor!
...
//        textField.widthAnchor.constraint(equalToConstant: ).isActive = true
        textField.backgroundColor = textBackgroundColor
        textField.textAlignment = .center
        textField.adjustsFontSizeToFitWidth = false
        textField.font = .f20s
        textField.textColor = .c242424
