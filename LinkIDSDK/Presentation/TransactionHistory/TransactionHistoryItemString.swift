...
struct TransactionHistoryItemString{
    ...
    func normalTextStyle() -> [NSAttributedString.Key: Any] {
        let style: [NSAttributedString.Key: Any] = [.foregroundColor : UIColor.c030319!, .font : UIFont(name: FontName.regular, size: 14)!]
        return style
    }
    
    
    func boldTextStyle() -> [NSAttributedString.Key: Any] {
        let style: [NSAttributedString.Key: Any] = [.foregroundColor : UIColor.c030319!, .font : UIFont(name: FontName.semiBold, size: 14)!]
        return style
    }
    
    
    func primeTextStyle() -> [NSAttributedString.Key: Any] {
        let style: [NSAttributedString.Key: Any] = [.foregroundColor : UIColor.c0061A0!, .font : UIFont(name: FontName.semiBold, size: 14)!]
        return style
    }
    
    
    static func diamondTextStyle() -> [NSAttributedString.Key: Any] {
        let style: [NSAttributedString.Key: Any] = [.foregroundColor : UIColor.cB67924!, .font : UIFont(name: FontName.semiBold, size: 14)!]
        return style
    }
    
    
    func customText(color:String) -> [NSAttributedString.Key: Any] {
        let style: [NSAttributedString.Key: Any] = [.foregroundColor : UIColor.init(named: "#" + color)!, .font : UIFont(name: FontName.semiBold, size: 14)!]
        return style
    }
    ...
    func handlePointHistoryType(pointHistoryItem: TransactionItem) -> String {
        ...
        switch pointHistoryItem.actionType {
            ...
            case "PayByToken":
                let merchant = pointHistoryItem.storeName?.isEmpty ?? true ? pointHistoryItem.toMerchantNameOrMember : pointHistoryItem.storeName!
