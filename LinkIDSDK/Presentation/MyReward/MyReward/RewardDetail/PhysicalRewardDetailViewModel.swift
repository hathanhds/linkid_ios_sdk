...
class PhysicalRewardDetailViewModel: ViewModelType {
    ...
    init(myRewardRepository: MyrewardRepository, userRepository: UserRepository, giftTransactionCode: String) {
    ...
    func getFullLocation(cityId: String, districtId: String, wardId: String, shipAddress: String?) {
        ...
        dispatchGroup.notify(queue: .main) {
            ...
            if let shipAddrss = shipAddress, !shipAddrss.isEmpty {
                listAddress.append(shipAddrss)
            }
            if !cityName.isEmpty {
