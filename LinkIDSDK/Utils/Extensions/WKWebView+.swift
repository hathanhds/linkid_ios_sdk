...
//        self.evaluateJavaScript(js) { (html, error) in
//            self.loadHTMLStringWith(content: html as! String, baseURL: nil)
//        }
    ...
    func getWebView(withHTMLContent content:String ,withStyle type:WebViewType) {
        ...
        if let htmlPath = Bundle.main.path(forResource: "html_template", ofType: "html"),
